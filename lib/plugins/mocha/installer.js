...
class MochaInstaller {
    ...
    static getInstaller(operator) {
        ...
        return _asyncToGenerator(function* () {
            if (utils.checkExistsNpm('mocha') || (yield _this.operator.checkExists('test/mocha.opts')) || (yield _this.operator.checkExists('test/test-helper.js')) || (yield _this.operator.checkExists('test/test.js'))) {
                return null;
            }
    ...
    install() {
        ...
        return _asyncToGenerator(function* () {
            ...
            _this2.operator.addTester('mocha');
