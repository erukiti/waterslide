...
var GitSubomduleGenerator = function () {
    function GitSubomduleGenerator(operator) {
        _classCallCheck(this, GitSubomduleGenerator);

        this.operator = operator;
    }

    _createClass(GitSubomduleGenerator, [{
        key: 'generate',
        value: function () {
