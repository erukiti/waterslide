...
const createMenu = items => {
    return new Promise((resolve, reject) => {
        ...
        const workAround = process.stdin;
...
const configurable = [{ name: 'name', desc: 'your name (use author\'s credit)', cb: prompt }, { name: 'email', desc: 'your email (use author\'s credit)', cb: prompt }, { name: 'homepage', desc: 'your homepage url (use author\'s credit)', cb: prompt }, { name: 'license', desc: 'default license', cb: selectLicense }];
...
const configLoop = (() => {
    var _ref = _asyncToGenerator(function* () {
        let cb = yield configMenu().catch(function (e) {
            return console.dir(e);
        });
        for (;;) {
            if (!cb) {
                cb = yield configMenu().catch(function (e) {
                    return console.dir(e);
                });
            }
            cb = yield cb();
